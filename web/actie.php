...
if('POST' === $_SERVER['REQUEST_METHOD']){
	...
	$command = escapeshellcmd("/usr/bin/python3 /home/jenkins/workspace/Whine_main/front_end_actions.py 'process_bottle' 'intf_init_bottle.csv' '/var/www/html/interface_files' 2>&1");
